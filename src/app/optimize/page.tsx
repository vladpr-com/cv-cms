...
export default function OptimizePage() {
  ...
  async function handleGenerate() {
    ...
    const result = await generateResume(vacancyText, webhookUrl);
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-muted-foreground mb-4">
                Sign in to optimize your resume. Your career data stored in CV CMS will be used to generate a tailored resume for any job posting.
              </p>
              <AuthButton />
            </CardContent>
          </Card>
